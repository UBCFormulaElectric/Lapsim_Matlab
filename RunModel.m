 ...
 TP.Rcont1
 TP.Rcont1 = 0.5*10^-3/(2.5*0.00462)
 TP.Rcont2 = 3;
 TP.Rcond1 = 7;
 TP.CellHeatCap = 950;
 TP.Cellrho = 2270;
 ...
 plot(t,Lap_Tbase(:,1), 'r');
  title('Endurance Thermal Model','fontsize',20)
    ...
    legend('Cell Temp', 'Base Temp','Location','southeast')
